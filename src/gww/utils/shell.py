...
function gwc --description "Clone a repository and navigate to it"
...
function gwa --description "Add a worktree and navigate to it"
...
function gwr --description "Remove a worktree (prompts for force if dirty)"
